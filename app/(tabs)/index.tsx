...
const styles = StyleSheet.create({
  ...
  recentBubble: { backgroundColor: COLORS.white, paddingVertical: 12, paddingHorizontal: 16, borderRadius: 18, alignSelf: 'flex-start', minWidth: 160, marginLeft: -1, shadowColor: '#000', shadowOpacity: 0.08, shadowRadius: 14, elevation: 10, position: 'relative' },
